...
#            self.move_id.line_ids.unlink()
            ...
            self._reconcile_payments(self.dev_invoice_line_ids)
            
            return True

    def _reconcile_payments(self, dev_invoice_line_ids):
        """Reconciles payments with the invoice based on allocation."""
        for line in dev_invoice_line_ids:
            ...
            payment_lines = self.move_id.line_ids.filtered(
                lambda l: l.adv_payment_id.id == line.id and
