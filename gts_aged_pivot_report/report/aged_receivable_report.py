# -*- coding: utf-8 -*-
# Copyright 2015-2019 Geo Technosoft

from odoo import api, fields, models, tools


class AgedReport(models.Model):
    '''
    ...
    total_ = fields.Float('Grand Total', readonly=True)
    ...
    date_inv = fields.Datetime('Invoice Date', readonly=True)
